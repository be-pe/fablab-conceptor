...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_TriggerCatalog p_TriggerCatalog;
        ...
        public static SteamVR_Input_ActionSet_TriggerCatalog TriggerCatalog
        {
            get
            {
                return SteamVR_Actions.p_TriggerCatalog.GetCopy<SteamVR_Input_ActionSet_TriggerCatalog>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_TriggerCatalog = ((SteamVR_Input_ActionSet_TriggerCatalog)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_TriggerCatalog>("/actions/TriggerCatalog")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.TriggerCatalog};
        }
    }
}
